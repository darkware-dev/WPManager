...
public class CronResource
{
    ...
    public List<CronEvent> list()
    {
        List<CronEvent> events = this.manager.getCronAgent().getScheduledEvents().stream().collect(Collectors.toList());
        Collections.sort(events, new CronEvent.ExecTimeComparator());
